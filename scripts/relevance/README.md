...
(see [`generation`](../event_extraction/generation/README.md)). Three filtering modes can be
...
```bash
python scripts/relevance/local.py \
  --input  dataset/zhai/v3/articles.jsonl \
...
```bash
python scripts/relevance/view_relevance.py --input dataset/zhai/v3/articles.filtered.jsonl
```
