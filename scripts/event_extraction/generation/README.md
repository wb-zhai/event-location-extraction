...
Moved to its own package — see [`scripts/relevance/README.md`](../../relevance/README.md).
...
```bash
python scripts/event_extraction/generation/fix_events.py \
...
```bash
python scripts/event_extraction/generation/merge.py \
...
```bash
# Generation cost
python scripts/event_extraction/generation/costs.py dataset/zhai/v3/silver.jsonl
...
python scripts/event_extraction/generation/costs.py \
...
python scripts/event_extraction/generation/costs.py dataset/zhai/v3/silver.jsonl --batch
```
